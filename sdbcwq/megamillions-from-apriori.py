...
data = pd.read_csv('/Users/SpencerMacPro/Documents/GitHub/lottery/megamillions.csv', parse_dates=['date'], date_format='%m-%d-%y')
...
for _, row in data.iterrows():
    ...
    if row['date'] <= (data['date'].max() - pd.DateOffset(years=9)):
        continue
    date = row['date']
